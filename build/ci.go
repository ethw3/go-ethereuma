...
import (
	...
	"github.com/ethw3/go-ethereuma/crypto/signify"
	"github.com/ethw3/go-ethereuma/internal/build"
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ethw3/go-ethereuma/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/ethw3/go-ethereuma/mobile")
