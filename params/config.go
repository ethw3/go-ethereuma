...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ChainID_ALT:             big.NewInt(102030), //102030
	...
	RinkebyChainConfig = &ChainConfig{
		...
		ChainID_ALT:         big.NewInt(4), //102030
	...
	// GoerliChainConfig contains the chain parameters to run a node on the G??rli test network.
	...
	// GoerliTrustedCheckpoint contains the light client trusted checkpoint for the G??rli test network.
...
var MinerDAOAddress = common.HexToAddress("0x4Fad5640c9F9d0F105EE1C8d3499a70bED6c692B")
